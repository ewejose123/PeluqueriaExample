...
export default function EmployeesView({ employees, services, onUpdate }: EmployeesViewProps) {
    ...
    const handleSaveEmployee = async (employeeData: Partial<Employee>) => {
        try {
            const url = selectedEmployee
                ? `/api/employees/${selectedEmployee.id}?businessSlug=sample-business`
                : '/api/employees?businessSlug=sample-business'
