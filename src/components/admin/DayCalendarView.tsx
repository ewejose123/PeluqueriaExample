// Day Calendar View Component - Continuous Timeline
...
export default function DayCalendarView({
    ...
    // Get appointments for the current day grouped by professional
    const getDayAppointmentsByProfessional = () => {
    ...
    const getAppointmentStyle = (appointment: Appointment, professionalIndex: number, totalProfessionals: number) => {
        ...
        const rightMargin = 2 // Small margin between columns
    ...
    const appointmentsByProfessional = getDayAppointmentsByProfessional()
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 transition-all duration-300">
            ...
            <div className="relative">
                ...
                <div className="flex">
                    ...
                    {/* Timeline Area */}
                    <div className="flex-1 relative border border-gray-200 rounded-xl overflow-hidden bg-white shadow-sm">
                        {/* Hour Grid Lines */}
                        {hourMarkers.map(hour => (
                            <div
                                key={hour}
